...
<html lang="en">
    ...
    <head>
        <meta charset="utf-8">
        <title>Samahang Lugod ng Bayan (HUBO) Sinakulista 1901</title>
            ...
            <nav class="navbar navbar-expand-lg navbar-light bg-white px-4 px-lg-5 py-3 py-lg-0">
                ...
                <div class="collapse navbar-collapse" id="navbarCollapse">
                    <div class="navbar-nav ms-auto py-0">
                        ...
                        <a href="contact-SLBS-SH.html" class="nav-item nav-link">Contact SLBS-SH</a>
                    </div>
                    <a href="#" class="btn btn-primary rounded-pill text-white py-2 px-4 flex-wrap flex-sm-shrink-0">Makipag-ugnayan</a>
                </div>
            </nav>
                ...
                <div class="header-carousel-item">
                    ...
                    <div class="carousel-caption">
                        <div class="carousel-caption-content p-3">
                            ...
                            <p class="mb-5 fs-5">Magkita kita po tayo sa ganap na ika-walo ng gabi. 
                            </p>
                            <a class="btn btn-primary rounded-pill text-white py-3 px-5" href="#">Makipag-ugnayan</a>
                        </div>
                    </div>
                </div>
                <div class="header-carousel-item">
                    ...
                    <div class="carousel-caption">
                        <div class="carousel-caption-content p-3">
                            <h5 class="text-white text-uppercase fw-bold mb-4" style="letter-spacing: 3px;">March 28-31, 2024</h5>
                            <h1 class="display-1 text-capitalize text-white mb-4">Senakulo sa Kalayaan Park</h1>
                            <p class="mb-5 fs-5 animated slideInDown">Magkita kita po tayo sa ganap na ika-walo ng gabi. 
                            </p>
                            <a class="btn btn-primary rounded-pill text-white py-3 px-5" href="#">Makipag-ugnayan</a>
                        </div>
                    </div>
        ...
        <div class="container-fluid service py-5">
            <div class="container py-5">
                <div class="section-title mb-5 wow fadeInUp" data-wow-delay="0.2s">
                    <div class="sub-style">
                        <h4 class="sub-title px-3 mb-0">Ano ang SLBS-HS?</h4>
                    </div>
                    <h1 class="display-3 mb-4">Samahang Lugod ng Bayan (HUBO) Sinakulista 1901</h1>
                    <p class="mb-0">                   
                ...
                <div class="row g-5 align-items-center">
                    ...
                    <div class="col-lg-7 wow fadeInRight" data-wow-delay="0.4s">
                        <div class="section-title text-start mb-5">
                            <h4 class="sub-title pe-3 mb-0">Ang simula ng SLBS-HS</h4>
                            ...
                            <a href="#" class="btn btn-primary rounded-pill text-white py-3 px-5">Alamin pa...</a>
                        </div>
                    </div>
                </div>
            </div>
                ...
                <div class="row g-5 align-items-center">
                    ...
                    <div class="col-lg-6 wow fadeInRight" data-wow-delay="0.4s">
                        <div class="appointment-form rounded p-5">
                            <p class="fs-4 text-uppercase text-primary">Makipag-ugnayan</p>
                            <h1 class="display-5 mb-4">Get Appointment</h1>
                            <form action="#" method="POST">
                                <div class="row gy-3 gx-4">
                                    <div class="col-xl-6">
                                        <input type="text" name="name" class="form-control py-3 border-primary bg-transparent text-white" placeholder="Name" required>
                                    </div>
                                    <div class="col-xl-6">
                                    ...
                                    <div class="col-12">
                                        <button type="button" class="btn btn-primary text-white w-100 py-3 px-5" name="submit" value="Submit">SUBMIT NOW</button>
                                    </div>
                                </div>
                            </form>
                        </div>
                ...
                <div class="row g-5">
                    <div class="col-md-6 col-lg-6 col-xl-6">
                        <div class="footer-item d-flex flex-column">
                            <h4 class="text-white mb-4"></i>SLBS-HS since 1901</h4>
                            <p>Samahang Lugod ng Bayan (HUBO) Sinakulista 1901</p>
                    ...
                    <div class="col-md-6 col-lg-6 col-xl-3">
                        <div class="footer-item d-flex flex-column">
                            ...
                            <a href="about-SLBS-SH.html"><i class="fas fa-angle-right me-2"></i> About SLBS-HS</a>
                            <a href="contact-SLBS-SH.html"><i class="fas fa-angle-right me-2"></i> Contact Us</a>
                        </div>
                    </div>
                    <div class="col-md-6 col-lg-6 col-xl-3">
                        <div class="footer-item d-flex flex-column">
            ...
            <div class="container">
                <div class="row g-4 align-items-center">
                    <div class="col-md-6 text-center text-md-start mb-md-0">
                        <span class="text-white"><a href="#"><i class="fas fa-copyright text-light me-2"></i>SLBS-HS</a>, All right reserved.</span>
                    </div>
